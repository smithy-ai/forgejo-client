...
| [**createOrgVariable**](OrganizationApi.md#createOrgVariable) | **POST** /orgs/{org}/actions/variables/{variablename} | Create a new variable in organization |
...
| [**deleteOrgVariable**](OrganizationApi.md#deleteOrgVariable) | **DELETE** /orgs/{org}/actions/variables/{variablename} | Delete organization&#39;s variable by name |
| [**getOrgVariable**](OrganizationApi.md#getOrgVariable) | **GET** /orgs/{org}/actions/variables/{variablename} | Get organization&#39;s variable by name |
| [**getOrgVariablesList**](OrganizationApi.md#getOrgVariablesList) | **GET** /orgs/{org}/actions/variables | List variables of an organization |
...
| [**orgCheckQuota**](OrganizationApi.md#orgCheckQuota) | **GET** /orgs/{org}/quota/check | Check if the organization is over quota for a given subject |
...
| [**orgDeleteAvatar**](OrganizationApi.md#orgDeleteAvatar) | **DELETE** /orgs/{org}/avatar | Delete an organization&#39;s avatar. It will be replaced by a default one |
...
| [**orgGetAll**](OrganizationApi.md#orgGetAll) | **GET** /orgs | List all organizations |
...
| [**orgGetQuota**](OrganizationApi.md#orgGetQuota) | **GET** /orgs/{org}/quota | Get quota information for an organization |
...
| [**orgListActionsSecrets**](OrganizationApi.md#orgListActionsSecrets) | **GET** /orgs/{org}/actions/secrets | List actions secrets of an organization |
...
| [**orgListQuotaArtifacts**](OrganizationApi.md#orgListQuotaArtifacts) | **GET** /orgs/{org}/quota/artifacts | List the artifacts affecting the organization&#39;s quota |
| [**orgListQuotaAttachments**](OrganizationApi.md#orgListQuotaAttachments) | **GET** /orgs/{org}/quota/attachments | List the attachments affecting the organization&#39;s quota |
| [**orgListQuotaPackages**](OrganizationApi.md#orgListQuotaPackages) | **GET** /orgs/{org}/quota/packages | List the packages affecting the organization&#39;s quota |
...
| [**orgSearchRunJobs**](OrganizationApi.md#orgSearchRunJobs) | **GET** /orgs/{org}/actions/runners/jobs | Search for organization&#39;s action jobs according filter conditions |
| [**orgUnblockUser**](OrganizationApi.md#orgUnblockUser) | **PUT** /orgs/{org}/unblock/{username} | Unblock a user from the organization |
| [**orgUpdateAvatar**](OrganizationApi.md#orgUpdateAvatar) | **POST** /orgs/{org}/avatar | Update an organization&#39;s avatar |
...
| [**updateOrgVariable**](OrganizationApi.md#updateOrgVariable) | **PUT** /orgs/{org}/actions/variables/{variablename} | Update variable in organization |
...
import dev.smithyai.forgejoclient.api.OrganizationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    String variablename = "variablename_example"; // String | name of the variable
    try {
      apiInstance.deleteOrgVariable(org, variablename);
    } catch (ApiException e) {
...
<a id="orgCheckQuota"></a>
# **orgCheckQuota**
> Boolean orgCheckQuota(org, subject)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Boolean result = apiInstance.orgCheckQuota(org, subject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#orgCheckQuota");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    OrganizationApi apiInstance = new OrganizationApi(defaultClient);
    Long id = 56L; // Long | id of the team to edit
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **id** | **Long**| id of the team to edit | |
...
public class Example {
  public static void main(String[] args) {
    ...
    String org = "org_example"; // String | name of the organization
    try {
      QuotaInfo result = apiInstance.orgGetQuota(org);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#orgGetQuota");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> RegistrationToken orgGetRunnerRegistrationToken(org)
...
public class Example {
  public static void main(String[] args) {
    ...
    String org = "org_example"; // String | name of the organization
    try {
      RegistrationToken result = apiInstance.orgGetRunnerRegistrationToken(org);
      System.out.println(result);
    } catch (ApiException e) {
...
# **orgListLabels**
> List&lt;Label&gt; orgListLabels(org, sort, page, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer limit = 56; // Integer | page size of results
    try {
      List<Label> result = apiInstance.orgListLabels(org, sort, page, limit);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="orgListQuotaArtifacts"></a>
# **orgListQuotaArtifacts**
> List&lt;QuotaUsedArtifact&gt; orgListQuotaArtifacts(org, page, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer limit = 56; // Integer | page size of results
    try {
      List<QuotaUsedArtifact> result = apiInstance.orgListQuotaArtifacts(org, page, limit);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#orgListQuotaArtifacts");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="orgListQuotaAttachments"></a>
# **orgListQuotaAttachments**
> List&lt;QuotaUsedAttachment&gt; orgListQuotaAttachments(org, page, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer limit = 56; // Integer | page size of results
    try {
      List<QuotaUsedAttachment> result = apiInstance.orgListQuotaAttachments(org, page, limit);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#orgListQuotaAttachments");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="orgListQuotaPackages"></a>
# **orgListQuotaPackages**
> List&lt;QuotaUsedPackage&gt; orgListQuotaPackages(org, page, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer limit = 56; // Integer | page size of results
    try {
      List<QuotaUsedPackage> result = apiInstance.orgListQuotaPackages(org, page, limit);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#orgListQuotaPackages");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="orgSearchRunJobs"></a>
# **orgSearchRunJobs**
> List&lt;ActionRunJob&gt; orgSearchRunJobs(org, labels)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<ActionRunJob> result = apiInstance.orgSearchRunJobs(org, labels);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#orgSearchRunJobs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="teamSearch"></a>
# **teamSearch**
> TeamSearchResults teamSearch(org, q, includeDesc, page, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer limit = 56; // Integer | page size of results
    try {
      TeamSearchResults result = apiInstance.teamSearch(org, q, includeDesc, page, limit);
      System.out.println(result);
    } catch (ApiException e) {
