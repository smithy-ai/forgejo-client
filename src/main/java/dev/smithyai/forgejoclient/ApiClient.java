...
import dev.smithyai.forgejoclient.auth.Authentication;
import dev.smithyai.forgejoclient.auth.HttpBasicAuth;
import dev.smithyai.forgejoclient.auth.HttpBearerAuth;
import dev.smithyai.forgejoclient.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/14.0.2-24-ea4f733de8+gitea-1.22.0/java");
     ...
     * @return a {@link dev.smithyai.forgejoclient.ApiClient} object
     */
    ...
    */
     ...
     * @throws dev.smithyai.forgejoclient.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws dev.smithyai.forgejoclient.ApiException If fail to serialize the given object
     */
     ...
     * @throws dev.smithyai.forgejoclient.ApiException If fail to read file content from response and write to disk
     ...
     * @throws dev.smithyai.forgejoclient.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws dev.smithyai.forgejoclient.ApiException If the response has an unsuccessful status code or
     ...
     * @throws dev.smithyai.forgejoclient.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws dev.smithyai.forgejoclient.ApiException If fails to update the parameters
     */
     ...
     * @throws dev.smithyai.forgejoclient.ApiException If fail to serialize the request body object into a string
     */
