...
public class Hook {
   ...
   * @return the Hook instance itself
   */
  public Hook putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, hook.active) &&
        ...
        Objects.equals(this.additionalProperties, hook.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, authorizationHeader, branchFilter, config, contentType, createdAt, events, id, metadata, type, updatedAt, url, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Hook>() {
           ...
           public Hook read(JsonReader in) throws IOException {
             ...
             Hook instance = thisAdapter.fromJsonTree(jsonObj);
