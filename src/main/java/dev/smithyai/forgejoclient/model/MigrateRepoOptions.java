...
public class MigrateRepoOptions {
   ...
   * @return the MigrateRepoOptions instance itself
   */
  public MigrateRepoOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authPassword, migrateRepoOptions.authPassword) &&
        ...
        Objects.equals(this.additionalProperties, migrateRepoOptions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authPassword, authToken, authUsername, cloneAddr, description, issues, labels, lfs, lfsEndpoint, milestones, mirror, mirrorInterval, _private, pullRequests, releases, repoName, repoOwner, service, uid, wiki, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MigrateRepoOptions>() {
           ...
           public MigrateRepoOptions read(JsonReader in) throws IOException {
             ...
             MigrateRepoOptions instance = thisAdapter.fromJsonTree(jsonObj);
