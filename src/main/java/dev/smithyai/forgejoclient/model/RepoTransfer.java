...
public class RepoTransfer {
   ...
   * @return the RepoTransfer instance itself
   */
  public RepoTransfer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.doer, repoTransfer.doer) &&
        ...
        Objects.equals(this.additionalProperties, repoTransfer.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(doer, recipient, teams, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RepoTransfer>() {
           ...
           public RepoTransfer read(JsonReader in) throws IOException {
             ...
             RepoTransfer instance = thisAdapter.fromJsonTree(jsonObj);
