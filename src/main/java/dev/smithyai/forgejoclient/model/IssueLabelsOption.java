...
public class IssueLabelsOption {
  ...
  public IssueLabelsOption labels(@javax.annotation.Nullable List<Object> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public void setLabels(@javax.annotation.Nullable List<Object> labels) {
    this.labels = labels;
  }


  public IssueLabelsOption updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
   ...
   * @return the IssueLabelsOption instance itself
   */
  public IssueLabelsOption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.labels, issueLabelsOption.labels) &&
        Objects.equals(this.updatedAt, issueLabelsOption.updatedAt)&&
        Objects.equals(this.additionalProperties, issueLabelsOption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labels, updatedAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("labels", "updated_at"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueLabelsOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IssueLabelsOption is not found in the empty JSON string", IssueLabelsOption.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueLabelsOption>() {
           ...
           public IssueLabelsOption read(JsonReader in) throws IOException {
             ...
             IssueLabelsOption instance = thisAdapter.fromJsonTree(jsonObj);
