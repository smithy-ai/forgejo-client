...
public class PayloadCommit {
   ...
   * @return the PayloadCommit instance itself
   */
  public PayloadCommit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.added, payloadCommit.added) &&
        ...
        Objects.equals(this.additionalProperties, payloadCommit.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(added, author, committer, id, message, modified, removed, timestamp, url, verification, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PayloadCommit>() {
           ...
           public PayloadCommit read(JsonReader in) throws IOException {
             ...
             PayloadCommit instance = thisAdapter.fromJsonTree(jsonObj);
