...
public class RepoCommit {
   ...
   * @return the RepoCommit instance itself
   */
  public RepoCommit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.author, repoCommit.author) &&
        ...
        Objects.equals(this.additionalProperties, repoCommit.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(author, committer, message, tree, url, verification, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RepoCommit>() {
           ...
           public RepoCommit read(JsonReader in) throws IOException {
             ...
             RepoCommit instance = thisAdapter.fromJsonTree(jsonObj);
