...
public class FilesResponse {
  ...
  @javax.annotation.Nullable
  private List<ContentsResponse> files = new ArrayList<>();
  ...
  public FilesResponse commit(@javax.annotation.Nullable FileCommitResponse commit) {
    this.commit = commit;
    return this;
  }
  ...
  public FilesResponse files(@javax.annotation.Nullable List<ContentsResponse> files) {
    this.files = files;
    return this;
  }
  ...
  public void setFiles(@javax.annotation.Nullable List<ContentsResponse> files) {
    this.files = files;
  }


  public FilesResponse verification(@javax.annotation.Nullable PayloadCommitVerification verification) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("commit", "files", "verification"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FilesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FilesResponse is not found in the empty JSON string", FilesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FilesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FilesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
