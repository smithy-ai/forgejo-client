...
public class EditIssueOption {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignee, assignees, body, dueDate, milestone, ref, state, title, unsetDueDate, updatedAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EditIssueOption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EditIssueOption` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
