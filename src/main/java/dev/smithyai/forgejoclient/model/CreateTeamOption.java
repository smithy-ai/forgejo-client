...
public class CreateTeamOption {
  ...
  public CreateTeamOption canCreateOrgRepo(@javax.annotation.Nullable Boolean canCreateOrgRepo) {
  ...
  public CreateTeamOption description(@javax.annotation.Nullable String description) {
  ...
  public CreateTeamOption includesAllRepositories(@javax.annotation.Nullable Boolean includesAllRepositories) {
  ...
  public CreateTeamOption name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateTeamOption permission(@javax.annotation.Nullable PermissionEnum permission) {
  ...
  public CreateTeamOption units(@javax.annotation.Nullable List<String> units) {
    this.units = units;
    return this;
  }
  ...
  public CreateTeamOption unitsMap(@javax.annotation.Nullable Map<String, String> unitsMap) {
   ...
   * @return the CreateTeamOption instance itself
   */
  public CreateTeamOption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.canCreateOrgRepo, createTeamOption.canCreateOrgRepo) &&
        ...
        Objects.equals(this.additionalProperties, createTeamOption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(canCreateOrgRepo, description, includesAllRepositories, name, permission, units, unitsMap, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTeamOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateTeamOption is not found in the empty JSON string", CreateTeamOption.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateTeamOption>() {
           ...
           public CreateTeamOption read(JsonReader in) throws IOException {
             ...
             CreateTeamOption instance = thisAdapter.fromJsonTree(jsonObj);
