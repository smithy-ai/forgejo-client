...
public class Label {
  ...
  public Label color(@javax.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  public Label description(@javax.annotation.Nullable String description) {
  ...
  public Label exclusive(@javax.annotation.Nullable Boolean exclusive) {
  ...
  public Label id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public Label isArchived(@javax.annotation.Nullable Boolean isArchived) {
  ...
  public Label url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(color, description, exclusive, id, isArchived, name, url, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("color", "description", "exclusive", "id", "is_archived", "name", "url"));
