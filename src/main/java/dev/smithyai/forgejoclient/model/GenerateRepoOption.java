...
public class GenerateRepoOption {
   ...
   */
  public GenerateRepoOption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avatar, generateRepoOption.avatar) &&
        ...
        Objects.equals(this.additionalProperties, generateRepoOption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(avatar, defaultBranch, description, gitContent, gitHooks, labels, name, owner, _private, protectedBranch, topics, webhooks, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenerateRepoOption>() {
           ...
           public GenerateRepoOption read(JsonReader in) throws IOException {
             ...
             GenerateRepoOption instance = thisAdapter.fromJsonTree(jsonObj);
