...
public class Permission {
  ...
  public Permission admin(@javax.annotation.Nullable Boolean admin) {
    this.admin = admin;
    return this;
  }
  ...
  public Permission pull(@javax.annotation.Nullable Boolean pull) {
    this.pull = pull;
    return this;
  }
  ...
  public Permission push(@javax.annotation.Nullable Boolean push) {
    this.push = push;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(admin, pull, push, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("admin", "pull", "push"));
