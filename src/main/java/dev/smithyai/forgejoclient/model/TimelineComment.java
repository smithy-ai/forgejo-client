...
public class TimelineComment {
   ...
   * @return the TimelineComment instance itself
   */
  public TimelineComment putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimelineComment>() {
           ...
           public TimelineComment read(JsonReader in) throws IOException {
             ...
             TimelineComment instance = thisAdapter.fromJsonTree(jsonObj);
