...
public class User {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, avatarUrl, created, description, email, followersCount, followingCount, fullName, htmlUrl, id, isAdmin, language, lastLogin, location, login, loginName, prohibitLogin, pronouns, restricted, sourceId, starredReposCount, visibility, website);
  }
