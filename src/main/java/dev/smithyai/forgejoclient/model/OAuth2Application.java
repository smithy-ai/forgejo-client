...
public class OAuth2Application {
   ...
   * @return the OAuth2Application instance itself
   */
  public OAuth2Application putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, oauth2Application.clientId) &&
        ...
        Objects.equals(this.additionalProperties, oauth2Application.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, clientSecret, confidentialClient, created, id, name, redirectUris, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OAuth2Application>() {
           ...
           public OAuth2Application read(JsonReader in) throws IOException {
             ...
             OAuth2Application instance = thisAdapter.fromJsonTree(jsonObj);
