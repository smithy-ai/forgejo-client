...
public class PushMirror {
   ...
   * @return the PushMirror instance itself
   */
  public PushMirror putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.branchFilter, pushMirror.branchFilter) &&
        ...
        Objects.equals(this.additionalProperties, pushMirror.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(branchFilter, created, interval, lastError, lastUpdate, publicKey, remoteAddress, remoteName, repoName, syncOnCommit, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PushMirror>() {
           ...
           public PushMirror read(JsonReader in) throws IOException {
             ...
             PushMirror instance = thisAdapter.fromJsonTree(jsonObj);
