...
public class BranchProtection {
   ...
   * @return the BranchProtection instance itself
   */
  public BranchProtection putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BranchProtection>() {
           ...
           public BranchProtection read(JsonReader in) throws IOException {
             ...
             BranchProtection instance = thisAdapter.fromJsonTree(jsonObj);
